 ...
 */
public class MenpiaogoumaiModel  implements Serializable {
	...
	public void setDingpiaoriqi(Date dingpiaoriqi) {
		this.dingpiaoriqi = dingpiaoriqi;
	}
	
	/**
	 * 获取：订票日期
	 */
	public Date getDingpiaoriqi() {
		return dingpiaoriqi;
	}
