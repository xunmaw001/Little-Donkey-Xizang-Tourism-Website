...
<html>
	...
	<body>
		...
		<div id="app">
			...
			<!-- 标题 -->
			<div class="index-title" style="width: auto;" :style='{"padding":"10px 0 10px 0","boxShadow":"-8px -8px 0 #EC6F66","margin":"10px 0 10px 0","borderColor":"rgba(243, 161, 131, 1)","backgroundColor":"#fff","color":"rgba(0, 0, 0, 1)","borderRadius":"0","alignItems":"center","borderWidth":"4px 1px 1px","fontSize":"20px","borderStyle":"dashed solid solid"}'>
			  <span>NEWS / INFORMATION</span><span>景点资讯</span>
			</div>
			<!-- 标题 -->
			...
			<div class="recommend index-pv2" :style='{"padding":"10px 0 10px 0","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"0","borderColor":"rgba(0,0,0,.3)","borderRadius":"0","borderWidth":"0","background":"transparent","borderStyle":"solid"}'>
				...
				<form class="layui-form filter" :style='{"padding":"0 10px","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"10px 0 10px 0","borderColor":"rgba(0,0,0,.3)","backgroundColor":"rgba(0, 0, 0, 0)","borderRadius":"4px","borderWidth":"0","borderStyle":"solid","justifyContent":"flex-end","height":"64px"}'>
					<div class="item-list">
						<div class="lable" :style='{"padding":"0 10px","boxShadow":"0 0 0px rgba(255,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(255, 255, 255, 0)","color":"rgba(0, 0, 0, 1)","borderRadius":"0","textAlign":"right","borderWidth":"0","width":"auto","fontSize":"16px","borderStyle":"solid"}'>标题</div>
						<input type="text" :style='{"boxShadow":"0 0 6px rgba(255,0,0,0)","borderColor":"rgba(236, 111, 102, 1)","backgroundColor":"rgba(245, 245, 245, 1)","color":"#333","borderRadius":"8px","textAlign":"center","borderWidth":"1px","width":"140px","fontSize":"14px","borderStyle":"solid","height":"44px"}' name="title" id="title" placeholder="标题" autocomplete="off" class="layui-input">
					</div>
					...
					<!-- 样式二 -->
					<div class="list news">
						<div @click="jump('../news/detail.jsp?id='+item.id);" v-for="(item,index) in dataList" :key="index" class="list-item" :class="1=='1'?'list-item1':1=='3'?'list-item3':''">
							<div class="list-item-body animation-box" :style='{"padding":"0 10px 20px","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"0 0 10px 0","borderColor":"rgba(0,0,0,.3)","backgroundColor":"rgba(249, 249, 249, 1)","borderRadius":"4px","borderWidth":"0","borderStyle":"solid"}'>
								<img :style='{"boxShadow":"0 0 0px rgba(110,22,64,.8)","borderColor":"rgba(0,0,0,.3)","borderRadius":"0 0 30px 30px","borderWidth":"0","width":"40%","borderStyle":"solid","height":"150px"}' :src="baseurl+item.picture">
								<div class="item-info">
									<div v-if="true" :style='{"isshow":true,"padding":"0 20px","margin":"5px 0 0 0","backgroundColor":"rgba(0,0,0,0)","color":"rgba(0, 0, 0, 1)","borderRadius":"0","textAlign":"left","width":"100%","fontSize":"18px"}' class="name">{{item.title}}</div>
									<div v-if="item.introduction" :style='{"padding":"0 20px","margin":"10px 0 0 0","backgroundColor":"rgba(0,0,0,0)","color":"rgba(243, 161, 131, 1)","borderRadius":"0","textAlign":"left","width":"100%","fontSize":"14px"}' class="time">{{item.introduction}}</div>
								</div>
							</div>
						</div>
					</div>
