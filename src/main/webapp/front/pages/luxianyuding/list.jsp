		...
		<div id="app">
			...
			<div class="recommend index-pv1" :style='{"padding":"10px 0 10px 0","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"0","borderColor":"rgba(0,0,0,.3)","borderRadius":"0","borderWidth":"0","background":"transparent","borderStyle":"solid"}'>
				<div class="box" style='width:80%'>
					  ...
					  <span>DATA SHOW</span><span>路线预定展示</span>
					</div>
					...
					<div class="item-list">
						<div class="lable" :style='{"padding":"0 10px","boxShadow":"0 0 0px rgba(255,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(255, 255, 255, 0)","color":"rgba(0, 0, 0, 1)","borderRadius":"0","textAlign":"right","borderWidth":"0","width":"auto","fontSize":"16px","borderStyle":"solid"}'>预定时间</div>
						<input type="text" :style='{"boxShadow":"0 0 6px rgba(255,0,0,0)","borderColor":"rgba(236, 111, 102, 1)","backgroundColor":"rgba(245, 245, 245, 1)","color":"#333","borderRadius":"8px","textAlign":"center","borderWidth":"1px","width":"140px","fontSize":"14px","borderStyle":"solid","height":"44px"}' name="yudingshijianstart" id="yudingshijianstart" placeholder="预定时间起始" autocomplete="off" class="layui-input">
						...
						<input type="text" :style='{"boxShadow":"0 0 6px rgba(255,0,0,0)","borderColor":"rgba(236, 111, 102, 1)","backgroundColor":"rgba(245, 245, 245, 1)","color":"#333","borderRadius":"8px","textAlign":"center","borderWidth":"1px","width":"140px","fontSize":"14px","borderStyle":"solid","height":"44px"}' name="yudingshijianend" id="yudingshijianend" placeholder="预定时间结束" autocomplete="off" class="layui-input">
					</div>
						...
						<div class="list" style="position: relative;">
							<div @click="jump('../luxianyuding/detail.jsp?id='+item.id)" v-for="(item,index) in dataList" :key="index" class="list-item" :class="4=='3'?'list-item3':4=='5'?'list-item5':''">
		...
		<script>
			...
			layui.use(['layer', 'element', 'carousel', 'laypage', 'http', 'jquery','laydate'], function() {
				...
				http.request('config/list', 'get', {
			      ...
			      laydate.render({
					elem: '#yudingshijianstart',
					type: 'datetime'
				});
			      laydate.render({
					elem: '#yudingshijianend',
					type: 'datetime'
				});
				...
				function pageList() {
			        ...
			        if (jquery('#yudingshijianstart').val()) {
			            param['yudingshijianstart'] = jquery('#yudingshijianstart').val() ? jquery('#yudingshijianstart').val() : '';
			        }
			        if (jquery('#yudingshijianend').val()) {
			            param['yudingshijianend'] = jquery('#yudingshijianend').val() ?  jquery('#yudingshijianend').val() : '';
			        }
				...
				if (jquery('#yudingshijian').val()) {
					param['yudingshijian'] = jquery('#yudingshijian').val() ? '%' + jquery('#yudingshijian').val() + '%' : '';
				}  
			        param['sfsh'] = '是';

					// 获取列表数据
					http.request('luxianyuding/list', 'get', param, function(res) {
