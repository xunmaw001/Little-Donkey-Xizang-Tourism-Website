				...
				<div class="box" style='width:80%'>
					...
					<form class="layui-form filter" :style='{"padding":"0 10px","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"10px 0 10px 0","borderColor":"rgba(0,0,0,.3)","backgroundColor":"rgba(0, 0, 0, 0)","borderRadius":"4px","borderWidth":"0","borderStyle":"solid","justifyContent":"flex-end","height":"64px"}'>
						...
						<div class="item-list">
							...
							<input type="text" :style='{"boxShadow":"0 0 6px rgba(255,0,0,0)","borderColor":"rgba(236, 111, 102, 1)","backgroundColor":"rgba(245, 245, 245, 1)","color":"#333","borderRadius":"8px","textAlign":"center","borderWidth":"1px","width":"140px","fontSize":"14px","borderStyle":"solid","height":"44px"}' name="jingdianmingcheng" id="jingdianmingcheng" placeholder="景点名称" autocomplete="off" class="layui-input">
						</div>
					<div class="item-list">
						<div class="lable" :style='{"padding":"0 10px","boxShadow":"0 0 0px rgba(255,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(255, 255, 255, 0)","color":"rgba(0, 0, 0, 1)","borderRadius":"0","textAlign":"right","borderWidth":"0","width":"auto","fontSize":"16px","borderStyle":"solid"}'>景点星级</div>
						<select :style='{"boxShadow":"0 0 6px rgba(255,0,0,0)","borderColor":"rgba(236, 111, 102, 1)","backgroundColor":"rgba(245, 245, 245, 1)","color":"#333","borderRadius":"8px","textAlign":"center","borderWidth":"1px","width":"140px","fontSize":"14px","borderStyle":"solid","height":"44px"}' style="display:block" name="jingdianxingji" id="jingdianxingji" lay-filter="jingdianxingji">
							<option value="">请选择</option>
							<option v-for="(item,index) in jingdianxingjiOptions" v-bind:key="index" :value="item">{{item}}</option>
						</select>
					</div>
						<div class="item-list">
							<div class="lable" :style='{"padding":"0 10px","boxShadow":"0 0 0px rgba(255,0,0,0)","margin":"0","borderColor":"rgba(0,0,0,0)","backgroundColor":"rgba(255, 255, 255, 0)","color":"rgba(0, 0, 0, 1)","borderRadius":"0","textAlign":"right","borderWidth":"0","width":"auto","fontSize":"16px","borderStyle":"solid"}'>景点地址</div>
							<input type="text" :style='{"boxShadow":"0 0 6px rgba(255,0,0,0)","borderColor":"rgba(236, 111, 102, 1)","backgroundColor":"rgba(245, 245, 245, 1)","color":"#333","borderRadius":"8px","textAlign":"center","borderWidth":"1px","width":"140px","fontSize":"14px","borderStyle":"solid","height":"44px"}' name="jingdiandizhi" id="jingdiandizhi" placeholder="景点地址" autocomplete="off" class="layui-input">
						</div>
		...
		<div v-if="1 == 1" style="position: absolute;left: 0;top: 0;transform: translate3d(-100%, 0, 0);" :style='{"padding":"0 20px","boxShadow":"0 0 0px rgba(255,0,0,0)","margin":"0 0px 0 0","borderColor":"rgba(0,0,0,1)","backgroundColor":"rgba(0,0,0,0)","borderRadius":"0","borderWidth":"0","width":"140px","borderStyle":"solid","height":"auto"}'>
			...
			<div v-for="(item,index) in categoryList" :key="index" >
				<div style="text-align: center;cursor: pointer;box-sizing: border-box;" :style='swiperIndex==index?{"padding":"0 10px","boxShadow":"4px -4px 0 #F3A183","margin":"4px 0","borderColor":"rgba(243, 161, 131, 1)","backgroundColor":"rgba(255, 255, 255, 1)","color":"rgba(0, 0, 0, 1)","borderRadius":"0","borderWidth":"4px 1px 1px","width":"100%","lineHeight":"34px","fontSize":"14px","borderStyle":"dashed solid solid"}:{"padding":"0 10px","boxShadow":"4px -4px 0px #ABABAB","margin":"10px 0","borderColor":"rgba(194, 194, 194, 1)","backgroundColor":"#fff","color":"rgba(171, 171, 171, 1)","borderRadius":"0","borderWidth":"4px 1px 1px","width":"100%","lineHeight":"34px","fontSize":"14px","borderStyle":"dashed solid solid"}' :index="index" class="category-search">{{categoryList[index]}}</div>
							...
							<div @click="jump('../jingdianxinxi/detail.jsp?id='+item.id)" v-for="(item,index) in dataList" :key="index" class="list-item" :class="4=='3'?'list-item3':4=='5'?'list-item5':''">
								<div class="list-item-body animation-box" :style='{"padding":"20px 0","boxShadow":"0 0 0px rgba(110,22,64,.8)","margin":"0 0 10px 0","borderColor":"rgba(0,0,0,.3)","backgroundColor":"rgba(249, 249, 249, 1)","borderRadius":"0 20px 20px 0","borderWidth":"0","borderStyle":"solid"}'>
									<img :style='{"boxShadow":"0 0 0px rgba(110,22,64,.8)","borderColor":"rgba(243, 161, 131, 1)","borderRadius":"0 30px 30px 0","borderWidth":"4px","width":"90%","borderStyle":"solid","height":"330px"}' :src="item.jingdiantupian?baseurl+item.jingdiantupian.split(',')[0]:''">
									<div class="info">
										...
										<div v-if="true" :style='{"isshow":true,"padding":"0","margin":"10px 0 0 0","backgroundColor":"rgba(0,0,0,0)","color":"rgba(0, 0, 0, 1)","borderRadius":"0","textAlign":"center","width":"100%","fontSize":"16px"}' class="name">{{item.jingdianmingcheng}}</div>
									</div>
								</div>
							</div>
						</div>
		...
		<script>
			...
			layui.use(['layer', 'element', 'carousel', 'laypage', 'http', 'jquery','laydate'], function() {
				...
				http.request('config/list', 'get', {
			        ...
			        vue.jingdianxingjiOptions = 'A,AA,AAA,AAAA,AAAAA'.split(',')
				...
				//类型搜索
				  ...
				  // 获取列表数据
				  http.request('option/jingdianfenlei/jingdianfenlei', 'get', {}, function(res) {
				...
				if(category!=null && category!='全部') {
					...
					if (jquery('#jingdianxingji').val()) {
						param['jingdianxingji'] = '';
					}
				...
				if(vCategory!='' && category!='全部') {
			        ...
			        if (jquery('#jingdianxingji').val()) {
			          param['jingdianxingji'] = jquery('#jingdianxingji').val() ? jquery('#jingdianxingji').val() : '';
			        }
			        if (jquery('#jingdiandizhi').val()) {
				...
				if (indexQueryCondition) {
					param['jingdianmingcheng'] = '%' + indexQueryCondition + '%';
