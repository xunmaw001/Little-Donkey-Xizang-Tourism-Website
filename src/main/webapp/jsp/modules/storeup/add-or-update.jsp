					...
					<div class="row breadcrumb-bar">
						...
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>收藏表管理</span></li>
								<li class="breadcrumb-item active"><span>编辑收藏表</span></li>
							</ol>
						</div>
					</div>
				</div>
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>收藏名称</label>
										<input name="name" id="name" name="name" class="form-control" placeholder="收藏名称">
									</div>
									<div class="form-group col-md-6">
										<label>收藏图片</label>
									...
									<div class="form-group col-md-6">
										<label>推荐类型</label>
										<input name="inteltype" id="inteltype" name="inteltype" class="form-control" placeholder="推荐类型">
									</div>
