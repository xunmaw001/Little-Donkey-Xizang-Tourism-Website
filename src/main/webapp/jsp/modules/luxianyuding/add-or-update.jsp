...
<body>
		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑路线预定</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑路线预定</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">路线预定信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>预定内容</label>
										<input name="yudingneirong" id="yudingneirong" name="yudingneirong" class="form-control" placeholder="预定内容">
									</div>
									<div class="form-group col-md-6">
										<label>用户名</label>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "luxianyuding/info/" + id,
		...
		function submit() {
               //获取表单数据前取消禁用
                $("#yudingshijian-input").attr('disabled',false);
				...
				if(crossrefid && crossuserid) {
					...
					http("luxianyuding/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("luxianyuding/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function dateTimePick(){
			...
			$("#yudingshijian-input").val(getCurDateTime());
		...
		function dataBind(){
			...
			$("#yudingneirong").val(ruleForm.yudingneirong);	
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.yudingneirong != null && res.data.yudingneirong != ''){

						$("#yudingneirong").val(res.data.yudingneirong);
						$("#yudingneirong").attr('readonly','readonly');
					}
		...
		function readonly(){
            if(window.sessionStorage.getItem('role')!="管理员") {
                ...
                $("#luxianmingcheng").attr('readonly','readonly');
                $("#luxiantupian").attr('readonly','readonly');
                $("#yudingshijian-input").attr('disabled',true);
                $("#yonghuming").attr('readonly','readonly');
                $("#shouji").attr('readonly','readonly');
            }
		}
