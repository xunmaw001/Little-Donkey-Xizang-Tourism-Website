...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>景点名称</label>
										<select  class="form-control"  name="jingdianmingcheng" id="jingdianmingchengSelect" onchange="jingdianmingchengSelect2Change()">
										</select>
									</div>
									<div class="form-group col-md-6">
										<label>景点分类</label>
										<input id="jingdianfenlei" name="jingdianfenlei" class="form-control"  value="" readonly>
									</div>
									<div class="form-group col-md-6">
										<label>景点地址</label>
										<input id="jingdiandizhi" name="jingdiandizhi" class="form-control"  value="" readonly>
									</div>
									<div class="form-group col-md-6">
										<label>路线图片</label>
									...
									<div class="form-group col-md-6">
										<label>途径路段</label>
										<input name="tujingluduan" id="tujingluduan" name="tujingluduan" class="form-control" placeholder="途径路段">
									</div>
									<div class="form-group col-md-6">
										<label>终点</label>
									...
									<div class="form-group col-md-6">
										<label>出行方式</label>
										<input name="chuxingfangshi" id="chuxingfangshi" name="chuxingfangshi" class="form-control" placeholder="出行方式">
									</div>
										
											<div class="form-group  col-md-12" >
												<label>路线详情</label>
												<div><div class="upload"><input id="luxianxiangqingupload" name="file" type="file">插入图片</div>
	...
	<script>
		...
		function jingdianmingchengSelect2(){
			http("option/jingdianxinxi/jingdianmingcheng","GET",{
				tableName: "jingdianxinxi",
				columnName: "jingdianmingcheng"
			},(res)=>{
				if(res.code == 0){
					var options = res.data;
					var option = document.createElement("option");
					$("#jingdianmingchengSelect").append(option)
					for(var i=0;i<options.length;i++){
						var jingdianmingchengOption = document.createElement("option");
						jingdianmingchengOption.setAttribute("value",options[i]);
						jingdianmingchengOption.setAttribute("class","jingdianmingchengOption");
						if(ruleForm.jingdianmingcheng == options[i]){
							jingdianmingchengOption.setAttribute("selected","selected");
						}
						jingdianmingchengOption.innerHTML = options[i];
						//修改 回显
						if(ruleForm.jingdianmingcheng != null && ruleForm.jingdianmingcheng != '' && options[i] == ruleForm.jingdianmingcheng){
							jingdianmingchengOption.setAttribute("selected","selected");
						}
						$("#jingdianmingchengSelect").append(jingdianmingchengOption);
					}
				}
			});
		}		
		function jingdianmingchengSelect2Change(){
			var options = document.getElementById("jingdianmingchengSelect").options;
			var index = document.getElementById("jingdianmingchengSelect").selectedIndex;
			var colVal = options[index].value;
			http("follow/jingdianxinxi/jingdianmingcheng","GET",{
				tableName: "jingdianxinxi",
				columnName: "jingdianmingcheng",
				columnValue: colVal
			},(res)=>{
				if(res.code == 0){
					if(res.data != null && res.data.jingdianfenlei != null){
						$("#jingdianfenlei").val(res.data.jingdianfenlei);
					}
					if(res.data != null && res.data.jingdiandizhi != null){
			...
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.jingdianfenlei != null && res.data.jingdianfenlei != ''){
						...
						$("#jingdianfenlei").val(res.data.jingdianfenlei);
						$("#jingdianfenlei").attr('readonly','readonly');
					}
					...
					if(res.data != null && res.data != '' && res.data.tujingluduan != null && res.data.tujingluduan != ''){

						$("#tujingluduan").val(res.data.tujingluduan);
						$("#tujingluduan").attr('readonly','readonly');
					}
					...
					if(res.data != null && res.data != '' && res.data.chuxingfangshi != null && res.data.chuxingfangshi != ''){

						$("#chuxingfangshi").val(res.data.chuxingfangshi);
						$("#chuxingfangshi").attr('readonly','readonly');
					}
