...
<body>
		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑景点信息</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>景点信息管理</span></li>
								<li class="breadcrumb-item active"><span>编辑景点信息</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">景点信息信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>景点星级</label>
										<select id="jingdianxingjiSelect" name="jingdianxingji" class="form-control">
												<option value=""></option>
												<option class="jingdianxingjiOption" value="A">
													A
												</option>
												<option class="jingdianxingjiOption" value="AA">
													AA
												</option>
												<option class="jingdianxingjiOption" value="AAA">
													AAA
												</option>
												<option class="jingdianxingjiOption" value="AAAA">
													AAAA
												</option>
												<option class="jingdianxingjiOption" value="AAAAA">
													AAAAA
												</option>
										</select>	
									</div>	
									...
									<div class="form-group col-md-6">
										<label>门票价格</label>
										<input name="menpiaojiage" id="menpiaojiage" name="menpiaojiage" class="form-control" placeholder="门票价格">
									</div>
									<div class="form-group col-md-6">
										<label>景点地址</label>
									...
									<div class="form-group col-md-6">
										<label>营业时间</label>
										<input name="yingyeshijian" id="yingyeshijian" name="yingyeshijian" class="form-control" placeholder="营业时间">
									</div>
									<div class="form-group col-md-6">
										<label>宣传视频</label>
										<div>
									...
									<div class="form-group col-md-6">
										<label>咨询热线</label>
										<input name="zixunrexian" id="zixunrexian" name="zixunrexian" class="form-control" placeholder="咨询热线">
									</div>
										
											<div class="form-group  col-md-12" >
												<label>景点介绍</label>
												<div><div class="upload"><input id="jingdianjieshaoupload" name="file" type="file">插入图片</div>
	...
	<script>
		...
		function jingdianfenleiSelect(){
			http("option/jingdianfenlei/jingdianfenlei","GET",{},(res)=>{
				if(res.code == 0){
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "jingdianxinxi/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("jingdianxinxi/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("jingdianxinxi/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("jingdianxinxi/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function calculationSE(colName){
			//单列求和接口
			http("jingdianxinxi"+colName,"GET",{
		...
		function dataBind(){
			...
			var jingdianxingjiOptions = document.getElementsByClassName("jingdianxingjiOption");
			for(var jingdianxingjiCount = 0; jingdianxingjiCount < jingdianxingjiOptions.length;jingdianxingjiCount++){
				if(jingdianxingjiOptions[jingdianxingjiCount].getAttribute('value') == ruleForm.jingdianxingji){
					jingdianxingjiOptions[jingdianxingjiCount].setAttribute('selected','selected');
				}
			}
			$("#jingdiantupian-input").val(ruleForm.jingdiantupian);
			$("#menpiaojiage").val(ruleForm.menpiaojiage);	
			...
			$("#zixunrexian").val(ruleForm.zixunrexian);	
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.jingdianxingji != null && res.data.jingdianxingji != ''){

						var jingdianxingjiOptions = document.getElementsByClassName("jingdianxingjiOption");
						for(var jingdianxingjiCount = 0; jingdianxingjiCount < jingdianxingjiOptions.length;jingdianxingjiCount++){
							if(jingdianxingjiOptions[jingdianxingjiCount].getAttribute('value') == res.data.jingdianxingji){
								jingdianxingjiOptions[jingdianxingjiCount].setAttribute('selected','selected');
							}
						}
					}
					...
					if(res.data != null && res.data != '' && res.data.menpiaojiage != null && res.data.menpiaojiage != ''){

						$("#menpiaojiage").val(res.data.menpiaojiage);
						$("#menpiaojiage").attr('readonly','readonly');
					}
					...
					if(res.data != null && res.data != '' && res.data.yingyeshijian != null && res.data.yingyeshijian != ''){
						...
						$("#yingyeshijian").attr('readonly','readonly');
					}
					...
					if(res.data != null && res.data != '' && res.data.zixunrexian != null && res.data.zixunrexian != ''){

						$("#zixunrexian").val(res.data.zixunrexian);
						$("#zixunrexian").attr('readonly','readonly');
					}
