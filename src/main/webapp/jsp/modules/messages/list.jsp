...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">网站评论管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>网站评论管理</span></li>
								<li class="breadcrumb-item active"><span>网站评论列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">网站评论列表</h3>							
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var cpictureCell  = document.createElement('td');

				                var cpictureImg = document.createElement('img');
			cpictureImg.setAttribute('src',baseUrl+item.cpicture);
			cpictureImg.setAttribute('height',100);
			cpictureImg.setAttribute('width',100);
			cpictureCell.appendChild(cpictureImg);


			row.appendChild(cpictureCell);
			...
			var rpictureCell  = document.createElement('td');

				                var rpictureImg = document.createElement('img');
			rpictureImg.setAttribute('src',baseUrl+item.rpicture);
			rpictureImg.setAttribute('height',100);
			rpictureImg.setAttribute('width',100);
			rpictureCell.appendChild(rpictureImg);


			row.appendChild(rpictureCell);
			...
			var replyAttr = 'edit(' +  item.id + ')';
			replyBtn.setAttribute("type","button");
			replyBtn.setAttribute("class","btn btn-warning btn-sm 回复");
			replyBtn.setAttribute("onclick",replyAttr);
