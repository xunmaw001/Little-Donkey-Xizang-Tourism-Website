		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑网站评论</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑网站评论</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">网站评论信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<img id="cpictureImg" src="" width="100" height="100">
									</div>

									<div class="form-group col-md-6">
									<label>回复图片</label>

									<img id="rpictureImg" src="" width="100" height="100">
									</div>
