		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑门票购买</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>门票购买管理</span></li>
								<li class="breadcrumb-item active"><span>编辑门票购买</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">门票购买信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>景点分类</label>
										<input name="jingdianfenlei" id="jingdianfenlei" name="jingdianfenlei" class="form-control" placeholder="景点分类">
									</div>
									<div class="form-group col-md-6">
										<label>景点图片</label>
									...
									<div class="form-group col-md-6">
										<label>门票价格</label>
										<input id="menpiaojiage" name="menpiaojiage" class="form-control" onchange="calculation()">
									</div>
									<div class="form-group col-md-6">
										<label>购买数量</label>
									...
									<div class="form-group col-md-6">
										<label>总价格</label>
										<input name="zongjiage" id="zongjiage" name="zongjiage" class="form-control" placeholder="总价格">
									</div>
									<div class="form-group col-md-6">
										<label>订票日期</label>
										<div id="dingpiaoriqiDate" class="input-append date form_datetime">
											<input id="dingpiaoriqi-input" name="dingpiaoriqi" size="15" type="text" readonly>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "menpiaogoumai/info/" + id,
				...
				if(crossrefid && crossuserid) {
					...
					http("menpiaogoumai/page","GET",{
						...
						if(res.data.total >= crossoptnum){
							...
							httpJson("menpiaogoumai/"+urlParam,"POST",data,(res)=>{
								if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("menpiaogoumai/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dateTimePick(){
			...
			$("#dingpiaoriqi-input").val(getCurDate());
			$("#dingpiaoriqiDate").datetimepicker({ 
				minView: "month",
				autoclose: true,
				format:'yyyy-mm-dd',
				language:'zh-CN',
		...
		function calculation(){
			...
			if($("#menpiaojiage").val() != null && $("#menpiaojiage").val() != ""){
				if(x == 0 && flag < 2){
					x = (x+1) * parseFloat($("#menpiaojiage").val());
					flag++;
				}else{
					x = x * parseFloat($("#menpiaojiage").val());
					flag++;
				}
			}
		...
		function calculationSE(colName){
			//单列求和接口
			http("menpiaogoumai"+colName,"GET",{
		...
		function dataBind(){
			...
			$("#dingpiaoriqi-input").val(ruleForm.dingpiaoriqi);
			...
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.goumaishuliang != null && res.data.goumaishuliang != ''){
						...
						$("#goumaishuliang").attr('readonly','readonly');
					}
					...
					if(res.data != null && res.data != '' && res.data.dingpiaoriqi != null && res.data.dingpiaoriqi != ''){

						$("#dingpiaoriqi-input").val(res.data.dingpiaoriqi);
						$('#dingpiaoriqiFileName').val(res.data.dingpiaoriqi)
					}
