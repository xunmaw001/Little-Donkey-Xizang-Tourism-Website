						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<input id="zongjiage" name="zongjiage" class="form-control" v-model="ruleForm.zongjiage" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>订票日期</label>

									<input id="dingpiaoriqi" name="dingpiaoriqi" class="form-control" v-model="ruleForm.dingpiaoriqi" readonly>
									</div>
									<div class="form-group col-md-6">
									<label>备注</label>
