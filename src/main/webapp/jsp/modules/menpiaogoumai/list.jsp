...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">门票购买管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>门票购买列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">门票购买列表</h3>							
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<input type="text" id="jingdianfenleiSearch" class="form-control form-control-sm" placeholder="请输入景点分类" aria-controls="tableId">
                                    <label>
                                        是否通过
                                    </label>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('zongjiage')">总价格<i id="zongjiageIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('dingpiaoriqi')">订票日期<i id="dingpiaoriqiIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function search(){
			...
			if($('#jingdianfenleiSearch').val() != null && $('#jingdianfenleiSearch').val() != ''){
				searchForm.jingdianfenlei ="%" +  $('#jingdianfenleiSearch').val() + "%";
			}
		...
		function setDataRow(item,number){
			...
			var zongjiageCell  = document.createElement('td');

						 zongjiageCell.innerHTML = item.zongjiage;

			row.appendChild(zongjiageCell);
			var dingpiaoriqiCell  = document.createElement('td');

						  dingpiaoriqiCell.innerHTML = item.dingpiaoriqi;


			row.appendChild(dingpiaoriqiCell);
		...
		function sh(){
			...
			httpJson("menpiaogoumai/update","POST",data,(res)=>{
				if(res.code == 0){
					alert("提交成功");
					getDataList();
				}
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("menpiaogoumai/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"menpiaogoumai");
        ...
        function pay(item){
			...
			window.sessionStorage.setItem('tableName',"menpiaogoumai");
