<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<style>
		...
		.top-brand .nav .fullscreen {
			...
			border-style: solid;
			border-color: rgba(0,0,0,.3);
			background-color: rgba(16, 164, 146, 1);
		...
		.top-brand .nav .dropdown-menu.profile::before {
			left: 100%;
			margin-left: -28px;
			border-bottom-color: rgba(251, 187, 90, 1);
		}
				...
				<div class="container top-brand" style="display: flex;">
					...
					<nav class="navbar navbar-default">			
						<div class="navbar-header">
							<a href="${pageContext.request.contextPath}/index.jsp">小驴西藏旅游网站的设计与实现</a>
						</div>
